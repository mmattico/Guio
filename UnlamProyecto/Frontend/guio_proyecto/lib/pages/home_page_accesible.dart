...
class _AccesibleHome extends State<AccesibleHome> {
  ...
  final List<String> areasPermitidas = ['Cardiología', 'Clínica Médica', 'Dermatologia']; //Agregar la lista de nombres de nodos activos
  ...
  void _listen(int textFieldIndex, String label) async {
    ...
    if (!_isListening) {
      ...
      _speech.stop();
      speak("Fin del reconocimiento, Prosiga");
    }
  }
  ...
  void _mostrarAlerta(String campo) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        speak("Disculpe no he entendido, intente nuevamente");
        _timer?.cancel();
