...
class _NavigationState extends State<Navigation> {
  ...
  void onStepCount(StepCount event) {
    ...
    if (_primeraLectura) {//seteo de primer lectura
      ...
      setState(() {
        int resetConteoPasos = pasosActuales - _pasosIniciales;
        _pasosValue = resetConteoPasos.toString();
        _distanciaValue = (resetConteoPasos * stepLength).toStringAsFixed(2);
        distanciaRecorrida = (resetConteoPasos * stepLength) as int; // Actualiza distancia recorrida
      });
    }
  }
